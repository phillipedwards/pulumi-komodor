...
func NewRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.RegisterResource("komodor:index/role:Role", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRole(ctx *pulumi.Context,
	...
	var resource Role
	err := ctx.ReadResource("komodor:index/role:Role", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o RoleOutput) IsDefault() pulumi.BoolOutput {
	return o.ApplyT(func(v *Role) pulumi.BoolOutput { return v.IsDefault }).(pulumi.BoolOutput)
}
